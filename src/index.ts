...
import type { CaptchaConfig, ChallengeType } from './types/index';
...
// Utility functions
export const createCaptchaConfig = (overrides: Partial<CaptchaConfig> = {}): CaptchaConfig => {
  return {
    ...DEFAULT_CONFIG,
    ...overrides,
    theme: {
 ...
 */
export const validateConfig = (config: CaptchaConfig): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
