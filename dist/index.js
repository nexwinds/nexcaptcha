...
function useCaptcha(options = {}) {
  ...
  const invisibleFiltersRef = useRef(createInvisibleFiltersTracker());
  const proofOfWorkChallengeRef = useRef(null);
  const proofOfWorkNonceRef = useRef(null);
  ...
  const trackMouseMovement = useCallback((x, y, type = "move") => {
  ...
  const setHoneypotValue = useCallback((value) => {
...
var Captcha = ({
  ...
  const [_draggedItem, setDraggedItem] = useState2(null);
  const [selectedAudio, setSelectedAudio] = useState2(null);
  const [_selectedEmoji, setSelectedEmoji] = useState2(null);
  const [showModal, setShowModal] = useState2(false);
  const [modalStep, setModalStep] = useState2(0);
  const {
    isLoading,
    isVerifying,
    isCompleted,
  ...
  const renderModal = () => {
    ...
    if (challenge || isCompleted && result) {
      return /* @__PURE__ */ jsx("div", { className: "nexcaptcha-modal-overlay", onClick: handleModalClose, children: /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal nexcaptcha-challenge-modal", onClick: (e) => e.stopPropagation(), children: [
        /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal-header", children: [
          /* @__PURE__ */ jsx("h3", { children: getTranslation(lang, "title") }),
          /* @__PURE__ */ jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal-body", children: [
          isLoading && /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-loading", children: [
            /* @__PURE__ */ jsx("div", { className: "nexcaptcha-spinner" }),
            /* @__PURE__ */ jsx("div", { children: getTranslation(lang, "loading") })
          ] }),
          isVerifying && /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-verifying", children: [
            /* @__PURE__ */ jsx("div", { className: "nexcaptcha-spinner" }),
            /* @__PURE__ */ jsx("div", { children: getTranslation(lang, "verifying") })
          ] }),
          isCompleted && result && result.success && /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-success", children: [
            /* @__PURE__ */ jsx("div", { className: "nexcaptcha-checkmark", children: "\u2713" }),
            /* @__PURE__ */ jsx("div", { children: getTranslation(lang, "success") }),
            /* @__PURE__ */ jsx(
              "button",
              {
          ...
          isCompleted && result && !result.success && /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-error", children: [
            /* @__PURE__ */ jsx("div", { className: "nexcaptcha-error-icon", children: "\u2717" }),
            /* @__PURE__ */ jsx("div", { children: error ?? getTranslation(lang, "failed") }),
            /* @__PURE__ */ jsx("div", { className: "nexcaptcha-error-details", children: result.errors?.map((err, index) => /* @__PURE__ */ jsx("div", { className: "nexcaptcha-error-item", children: err }, index)) }),
            /* @__PURE__ */ jsx(
              "button",
              {
                className: "nexcaptcha-btn nexcaptcha-btn-primary nexcaptcha-btn-lg",
          ...
          !isLoading && !isVerifying && !isCompleted && challenge && /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-challenge", children: [
            /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-challenge-content", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "nexcaptcha-challenge-actions", children: /* @__PURE__ */ jsxs(
              "button",
              {
        ...
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-modal-footer", children: /* @__PURE__ */ jsx("div", { className: "nexcaptcha-attribution", children: getTranslation(lang, "attribution") }) })
      ] }) });
    }
    const stepContent = getModalStepContent();
    if (!stepContent) return null;
    return /* @__PURE__ */ jsx("div", { className: "nexcaptcha-modal-overlay", onClick: handleModalClose, children: /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal-header", children: [
        /* @__PURE__ */ jsx("h3", { children: stepContent.title }),
        /* @__PURE__ */ jsx(
          "button",
          {
            className: "nexcaptcha-modal-close",
      ...
      /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal-body", children: [
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-modal-content", children: /* @__PURE__ */ jsx("div", { children: stepContent.content }) }),
        modalStep === 2 && /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-audio-instructions", children: [
          /* @__PURE__ */ jsx("h4", { children: getTranslation(lang, "audioIntegrationTitle") }),
          /* @__PURE__ */ jsxs("ol", { children: [
            /* @__PURE__ */ jsx("li", { children: getTranslation(lang, "audioStep1") }),
            /* @__PURE__ */ jsx("li", { children: getTranslation(lang, "audioStep2") }),
            /* @__PURE__ */ jsx("li", { children: getTranslation(lang, "audioStep3") }),
            /* @__PURE__ */ jsx("li", { children: getTranslation(lang, "audioStep4") })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "nexcaptcha-audio-example", children: /* @__PURE__ */ jsxs(
            "button",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal-footer", children: [
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-modal-progress", children: Array.from({ length: 4 }, (_, i) => /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-modal-actions", children: [
          stepContent.showNext && /* @__PURE__ */ jsx(
            "button",
            {
              className: "nexcaptcha-btn nexcaptcha-btn-primary",
          ...
          stepContent.showStart && /* @__PURE__ */ jsx(
            "button",
            {
              className: "nexcaptcha-btn nexcaptcha-btn-primary",
      ...
      /* @__PURE__ */ jsx("div", { className: "nexcaptcha-modal-branding", children: /* @__PURE__ */ jsx(
        "a",
        {
  ...
  const renderDragDropChallenge = () => {
    ...
    const dragChallenge = challenge;
    return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-drag-drop", children: [
      /* @__PURE__ */ jsx("div", { className: "nexcaptcha-instruction", children: formatTranslation(lang, "dragInstruction", {
        source: dragChallenge.sourceEmoji,
        target: dragChallenge.targetEmoji
      }) }),
      /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-drag-area", children: [
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-source-area", children: /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-arrow", children: "\u2192" }),
        /* @__PURE__ */ jsx(
          "div",
          {
  ...
  const renderAudioChallenge = () => {
    ...
    const audioChallenge = challenge;
    return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-audio", children: [
      /* @__PURE__ */ jsx("div", { className: "nexcaptcha-instruction", children: audioChallenge.instruction }),
      /* @__PURE__ */ jsx("div", { className: "nexcaptcha-audio-options", children: audioChallenge.audioOptions.map((soundType, index) => /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-audio-option", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
  ...
  const renderEmojiChallenge = () => {
    ...
    const emojiChallenge = challenge;
    return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-emoji", children: [
      /* @__PURE__ */ jsx("div", { className: "nexcaptcha-instruction", children: formatTranslation(lang, "emojiInstruction", {
        target: emojiChallenge.targetEmoji
      }) }),
      /* @__PURE__ */ jsx("div", { className: "nexcaptcha-emoji-grid", children: emojiChallenge.emojiOptions.map((emoji, index) => /* @__PURE__ */ jsx(
        "button",
        {
  ...
  const _renderContent = () => {
    if (isLoading) {
      return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-loading", children: [
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-spinner" }),
        /* @__PURE__ */ jsx("div", { children: getTranslation(lang, "loading") })
      ] });
    }
    if (isVerifying) {
      return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-verifying", children: [
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-spinner" }),
        /* @__PURE__ */ jsx("div", { children: getTranslation(lang, "verifying") })
      ] });
    }
    if (isCompleted && result) {
      if (result.success) {
        return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-success", children: [
          /* @__PURE__ */ jsx("div", { className: "nexcaptcha-checkmark", children: "\u2713" }),
          /* @__PURE__ */ jsx("div", { children: getTranslation(lang, "success") })
        ] });
      } else {
        return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-error", children: [
          /* @__PURE__ */ jsx("div", { className: "nexcaptcha-error-icon", children: "\u2717" }),
          /* @__PURE__ */ jsx("div", { children: error ?? getTranslation(lang, "failed") }),
          /* @__PURE__ */ jsx(
            "button",
    ...
    return /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-challenge", children: [
      /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-challenge-content", children: [
  ...
  if (!challenge && !isLoading && !isCompleted) {
    return /* @__PURE__ */ jsxs("div", { className: `nexcaptcha ${className}`, ref: captchaRef, children: [
      /* @__PURE__ */ jsxs("div", { className: "nexcaptcha-start", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            type: "button",
            children: /* @__PURE__ */ jsx("div", { className: "nexcaptcha-checkmark-icon", children: "\u2713" })
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "nexcaptcha-start-text", children: getTranslation(lang, "clickToVerify") })
      ] }),
      renderModal()
    ] });
  }
